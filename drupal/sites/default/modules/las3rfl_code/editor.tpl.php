...
<table id="editor-container" cellspacing=0 cellpadding=0>
  ...
  <p>In the event of a crash; reload the page and press Ctrl-R in the editor to recover the last version. Ctrl-Enter to run, Ctrl-S to save, Ctrl-H for help.</p>
    </td>
  </tr>
</table>
